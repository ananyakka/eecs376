...
int main(int argc, char **argv) {
    ...
    // turn left and move 2 in y
   // quat = convertPlanarPhi2Quaternion(0.79); // get a quaternion corresponding to this heading
   // pose_stamped.pose.orientation = quat; 
    pose_stamped.pose.position.x=0;
    pose_stamped.pose.position.y=2.3; 
    path_srv.request.nav_path.poses.push_back(pose_stamped);

    pose_stamped.pose.position.x=0;
    pose_stamped.pose.position.y=-3.9; 
    path_srv.request.nav_path.poses.push_back(pose_stamped);

    pose_stamped.pose.position.x=0;
    pose_stamped.pose.position.y=4.5; 
    path_srv.request.nav_path.poses.push_back(pose_stamped);
    ...
    path_srv.request.nav_path.poses.push_back(pose_stamped);
     ...
     pose_stamped.pose.position.x=0;
    pose_stamped.pose.position.y=1.9; 
    path_srv.request.nav_path.poses.push_back(pose_stamped);

     pose_stamped.pose.position.x=0;
    pose_stamped.pose.position.y=-3.2; 
    path_srv.request.nav_path.poses.push_back(pose_stamped);
...
/*
    quat = convertPlanarPhi2Quaternion(3*0.79); // get a quaternion corresponding to this heading
    pose_stamped.pose.orientation = quat; 
    pose_stamped.pose.position.x=3;
    pose_stamped.pose.position.y=0; // say desired y-coord is 1.0
    path_srv.request.nav_path.poses.push_back(pose_stamped);
    
    quat = convertPlanarPhi2Quaternion(1.59); // get a quaternion corresponding to this heading
    pose_stamped.pose.orientation = quat;   
